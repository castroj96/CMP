    ...
    public function index()
    {
        $userData = DB::table('users')
            ...
            ->select('users.id as id', 'users.name as name', 'users.lastName as lName1', 'users.motherLastName as lName2',
                    ...
                    'districts.name as district', 'personaldata.address as address')->paginate(10);
        ...
        $pendingData = DB::table('users')
            ...
            ->select('users.id as id', 'users.name as name', 'users.lastName as lName1', 'users.motherLastName as lName2',
                'users.dateBirth as bDate', 'genders.description as gender', 'users.email as email')->paginate(10);
